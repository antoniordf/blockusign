...
export type ChainEIP712<formatters extends ChainFormatters | undefined = ChainFormatters | undefined, TransactionSignable = {}> = Chain<formatters, {
    ...
    getEip712Domain?: EIP712DomainFn<formatters extends ChainFormatters ? formatters['transactionRequest'] extends ChainFormatter ? ZkSyncTransactionSerializable & Parameters<formatters['transactionRequest']['format']>[0] : ZkSyncTransactionSerializable : ZkSyncTransactionSerializable, TransactionSignable> | undefined;
}>;
