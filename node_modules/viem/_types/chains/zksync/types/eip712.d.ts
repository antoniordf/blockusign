...
export type EIP712DomainFn<TTransactionSerializable extends ZkSyncTransactionSerializable = ZkSyncTransactionSerializable, TransactionSignable = {}> = (transaction: TTransactionSerializable) => EIP712Domain<TransactionSignable>;
export {};
