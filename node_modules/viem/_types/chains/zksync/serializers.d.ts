...
export declare function serializeTransaction(transaction: ZkSyncTransactionSerializable, signature?: Signature): `0x02${string}` | `0x01${string}` | `0x03${string}` | import("../../index.js").TransactionSerializedLegacy | `0x71${string}`;
