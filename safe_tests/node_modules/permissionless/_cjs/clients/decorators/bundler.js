...
const bundlerActions = (client) => ({
    sendUserOperation: async (args) => (0, sendUserOperation_1.sendUserOperation)(client, args),
    estimateUserOperationGas: (args, stateOverrides) => (0, estimateUserOperationGas_1.estimateUserOperationGas)(client, args, stateOverrides),
