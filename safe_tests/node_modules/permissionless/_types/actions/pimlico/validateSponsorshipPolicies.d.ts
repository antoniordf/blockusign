...
export type ValidateSponsorshipPoliciesParameters<entryPoint extends EntryPoint> = {
 ...
 * ]
 */
export declare const validateSponsorshipPolicies: <entryPoint extends EntryPoint, TTransport extends Transport = Transport, TChain extends Chain | undefined = Chain | undefined, TAccount extends Account | undefined = Account | undefined>(client: Client<TTransport, TChain, TAccount, PimlicoPaymasterRpcSchema<entryPoint>>, args: {
    userOperation: UserOperation<GetEntryPointVersion<entryPoint>>;
    entryPoint: entryPoint;
    sponsorshipPolicyIds: string[];
