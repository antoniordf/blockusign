...
export type FeeValuesEIP4844<TQuantity = bigint> = Assign<FeeValuesEIP1559<TQuantity>, {
    /** The maximum total fee per gas the sender is willing to pay for blob gas (in wei). */
    maxFeePerBlobGas: TQuantity;
}>;
export type FeeValues<TQuantity = bigint> = OneOf<FeeValuesLegacy<TQuantity> | FeeValuesEIP1559<TQuantity> | FeeValuesEIP4844<TQuantity>>;
