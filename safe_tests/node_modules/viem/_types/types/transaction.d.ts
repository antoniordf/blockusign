...
export type TransactionRequestEIP4844<TQuantity = bigint, TIndex = number, TTransactionType = 'eip4844'> = RequiredBy<TransactionRequestBase<TQuantity, TIndex>, 'to'> & RequiredBy<Partial<FeeValuesEIP4844<TQuantity>>, 'maxFeePerBlobGas'> & {
    accessList?: AccessList;
...
export type TransactionSerializableEIP4844<TQuantity = bigint, TIndex = number> = TransactionSerializableBase<TQuantity, TIndex> & Partial<FeeValuesEIP4844<TQuantity>> & {
    accessList?: AccessList;
    chainId: number;
    type?: 'eip4844';
    yParity?: number;
