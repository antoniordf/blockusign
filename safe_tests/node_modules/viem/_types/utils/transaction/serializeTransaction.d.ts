...
export declare function serializeTransaction<const transaction extends TransactionSerializable, _transactionType extends TransactionType = GetTransactionType<transaction>>(transaction: transaction, signature?: Signature): SerializedTransactionReturnType<transaction, _transactionType>;
...
export declare function toYParitySignatureArray(transaction: TransactionSerializableGeneric, signature?: Signature): `0x${string}`[];
export {};
